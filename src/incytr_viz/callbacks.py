...
from dash import Dash, ALL, dcc, ctx, callback
...
#         return (
#             dcc.send_data_frame(a_pathways.to_csv, f"{sdi.get('group_a_name')}.csv"),
#             dcc.send_data_frame(b_pathways.to_csv, f"{sdi.get('group_b_name')}.csv"),
#         )
